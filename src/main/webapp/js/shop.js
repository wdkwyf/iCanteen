	...
	Shop.prototype = {
	  init: function() {
		// Properties
			...
			this.requiredFields = {
				expression: {
					value: /^0?(13[0-9]|15[012356789]|17[678]|18[0-9]|14[57])[0-9]{8}$/
				},
		...
		displayUserDetails: function() {
			if( this.userDetails !== null ) {
				if( this.storage.getItem( "shipping-name" ) == null ) {
					var telephone = this.storage.getItem( "billing-telephone" );
					...
					var sTelephone = this.storage.getItem( "shipping-telephone" );
		...
		displayCart: function() {
			if( this.formCart !== null ) {
				//console.log(this.storage.getItem( this.cartName) );
				...
				if(document.getElementById("json-form")){
					...
					document.getElementById("product").value = this.storage.getItem( this.cartName);
					document.getElementById("custT").value = this.storage.getItem("billing-telephone");
					document.getElementById("custA").value = this.storage.getItem("billing-address");
		...
		_saveFormData: function( form ) {
			...
			for( var i = 0; i < fieldSet.length; ++i ) {
				...
				if( field.id == "fieldset-billing" ) {
					...
					self.storage.setItem( "billing-telephone",telephone );
					self.storage.setItem( "billing-address", address );
				} else {

					var sTelephone = document.querySelector( "#sTelephone" ).value;
